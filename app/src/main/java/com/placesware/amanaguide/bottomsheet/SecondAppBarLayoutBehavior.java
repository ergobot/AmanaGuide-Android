package com.placesware.amanaguide.bottomsheet;
...
import com.placesware.amanaguide.NavigationActivity;
import com.placesware.amanaguide.R;
...
public class SecondAppBarLayoutBehavior extends AppBarLayout.ScrollingViewBehavior {
    ...
    private void showTitleInToolBar() {
        ...
        CharSequence title = ((NavigationActivity)mContext).bottomSheetTextView.getText();

        int [] initialLocation = new int[2];
        ((NavigationActivity)mContext).bottomSheetTextView.getLocationOnScreen(initialLocation);
    ...
    private void showBackgroundInStatusBar() {
        ...
        {
            Window w = ((NavigationActivity)mContext).getWindow();
